      ...
      <section id="pricings" className="lg:h-[650px] container m-auto lg:flex gap-10 my-10">
        <article className="lg:w-1/3 flex flex-col justify-between bg-white h-full shadow-md border border-slate-200 rounded-lg px-10 py-10 lg:px-16 lg:py-20 text-center scale-y-95">
          ...
          <div className="flex justify-between items-center gap-5 mb-6">
            <div className="w-1/3 h-10 bg-white flex items-center">
              <Image className="object-contain  aspect-video w-full" src="/visa.png" alt="" width={100} height={200} />
            </div>
            <div className="w-1/3 h-10 bg-white flex items-center px-2">
              <Image className="object-contain w-full" src="/mercado-pago.webp" alt="" width={100} height={200} />
            </div>
            <div className="w-1/3 h-10 bg-white flex items-center px-5">
              <Image className="object-contain w-full" src="/master-card.png" alt="" width={100} height={200} />
            </div>
          </div>
