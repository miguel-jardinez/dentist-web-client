      ...
      <div className='grid lg:grid-cols-2 grid-cols-1 h-full auto-rows-fr'>
        <div className='flex flex-col justify-center items-start p-10'>
          <div className='px-5 lg:pr-20 lg:pl-0 lg:mb-4'>
            <p className='lg:mb-5'>Sonrisas hermosas, experiencia inigualable</p>
            <h1 className='lg:pb-2 text-3xl'>Compromiso en cumplir tus expectativas.</h1>
          </div>
          <div className='flex items-center bg-primary text-destructive-foreground rounded-full px-5 lg:px-10 py-2 lg:py-5 mb-4'>
            <h1 className='text-3xl'>Disfrutamos de verte feliz</h1>
          </div>
          <p className='mb-8'>Cada sonrisa es más que un resultado; es el reflejo de nuestro compromiso inquebrantable contigo y tu bienestar.</p>
